...
public abstract class RootAcbActivity extends ActionBarActivity implements OnClickListener{
	...
	public Dialog showPregrossDialog(String msg,int theme){
		if (progressDialog == null) {
			if (msg == null) {
				msg = "正在加载";
			}
			LLog.d("progressDialog == null");
			progressDialog = DialogUtils.getProgressDialog(this, null, msg, theme);
		}else{
